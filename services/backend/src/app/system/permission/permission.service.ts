...
export class PermissionService {
      ...
      const permissions = await this.drizzle.db
        ...
        .where(
          and(
            ...
            eq(Permission.resourceType, "api"),
          ),
        )
  ...
  async updatePermission(
    ...
    const permission = Array.isArray(updatedPermissions) ? updatedPermissions[0] : updatedPermissions
  ...
  async deletePermission(permissionId: number) {
    ...
    const permission = Array.isArray(deletedPermissions) ? deletedPermissions[0] : deletedPermissions
